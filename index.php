...
$accessToken = "EAALDUpemr1wBAHke2lxKHkSSrNoAQ6vvauQv2pZALPOaOQKL4ZCLlWcgW0jGrjP9TViZAacPfpK36KOkZBxbI5yJYX1ZBBLV3L9U9xp1Tl6ZBcdZBdSv8N6nhMtmfA8dsWNnDvzNb5E03zgalVMfXTTvZBwMlaHq9spTUCaFldJjSwZDZD";

if(isset($_REQUEST['hub_challenge'])){
	$challenge = $_REQUEST['hub_challenge'];
	$verify_token = $_REQUEST['hub_verify_token'];
	if ($verify_token === 'huorier_token_code') {
	echo $challenge;
	}
}
...
//                    'type': 'image',
//                    'payload': {
//                      'url': 'https://www.google.com.kh/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png'
//                    },
//               }
//            }
//    }";
...
//    curl_setopt($ch, CURLOPT_POSTFIELDS, $jsonDataImage);
